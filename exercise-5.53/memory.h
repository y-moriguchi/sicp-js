...
extern cell make_unary_operator_combination(char *op, cell expression);
extern cell make_binary_operator_combination(char *op, cell expression1, cell expression2);
